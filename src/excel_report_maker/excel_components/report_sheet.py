...
class ReportSheet:
    ...
    table_list: list["ReportTable"] = field(default_factory=list)
    ...
    @staticmethod
    def from_table_list(sheet_name: str, table_list: list["ReportTable"], *args, **kwargs):
        return ReportSheet(sheet_name=sheet_name, table_list=table_list, *args, **kwargs)
    ...
    def _create_report_sheet(self, excel_report: "ExcelReport"):
        ...
        ws.sheet_view.showGridLines = self.gridlines